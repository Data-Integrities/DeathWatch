    ...
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.description}>
          <Text style={styles.brandInline}>ObitNOTE</Text> is an obituary monitoring and notification service.  Add people's names and <Text style={styles.brandInline}>ObitNOTE</Text> will send you a text and email when an obituary for any of them is published in the US, Canada, the UK, Australia, or New Zealand.
        </Text>
