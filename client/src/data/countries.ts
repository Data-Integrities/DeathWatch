export interface Country {
  ...
  dial: string;    // phone dial code
}

// US appears first (pinned), then all countries alphabetically (US included again)
export const COUNTRIES_PINNED: Country[] = [
  { name: 'United States', code: 'US', dial: '+1' },
];

export const COUNTRIES_ALPHA: Country[] = [
